...
class MultiWii(object):
    ...
    def bind_rxtx(self) -> NoReturn:
        ...
        """
        self._send_message(MspCommands.BIND)
    ...
    def calibrate_accelerometer(self) -> NoReturn:
        ...
        """
        self._send_message(MspCommands.ACC_CALIBRATION)
    ...
    def reset_config(self) -> NoReturn:
        ...
        """
        self._send_message(MspCommands.RESET_CONF)
    ...
    def save_config_to_eeprom(self) -> NoReturn:
        ...
        """
        self._send_message(MspCommands.EEPROM_WRITE)
    ...
    def set_box(self) -> NoReturn:
        ...
        """
        self._send_message(MspCommands.SET_BOX)
    ...
    def set_head(self) -> NoReturn:
        ...
        """
        self._send_message(MspCommands.SET_HEAD)
    ...
    def set_misc(self) -> NoReturn:
        ...
        """
        self._send_message(MspCommands.SET_MISC)
    ...
    def set_motor(self) -> NoReturn:
        ...
        """
        self._send_message(MspCommands.SET_MOTOR)
    ...
    def set_pid(self) -> NoReturn:
        ...
        """
        self._send_message(MspCommands.SET_PID)
    ...
    def set_raw_gps(self) -> NoReturn:
        ...
        """
        self._send_message(MspCommands.SET_RAW_GPS)
    ...
    def set_raw_rc(self) -> NoReturn:
        ...
        """
        self._send_message(MspCommands.SET_RAW_RC)
    ...
    def set_rc_tuning(self) -> NoReturn:
        ...
        """
        self._send_message(MspCommands.SET_RC_TUNING)
    ...
    def set_servo_conf(self) -> NoReturn:
        ...
        """
        self._send_message(MspCommands.SET_SERVO_CONF)
